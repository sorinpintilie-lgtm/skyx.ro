...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative min-h-screen flex flex-col items-end justify-end pt-40 pb-0">
      ...
      <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="absolute right-4 md:right-12 bottom-32 md:bottom-40 z-10 w-[90%] md:w-96 glass-strong rounded-2xl p-6 md:p-8 shadow-2xl border-2 border-sky-cyan/30 animate-float">
